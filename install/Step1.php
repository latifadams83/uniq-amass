...
<body>
 ...
 else
 {
	...
	{
	echo 'background-image:url(images/step1_new.gif); background-repeat:no-repeat; background-position:49% 15px; height: 298px;">';
	}
	else
	{
	echo 'background-image:url(images/step1.gif); background-repeat:no-repeat; background-position:49% 15px; height: 298px;">';
	} ?>
