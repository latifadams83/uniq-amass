    ...
    <tr>
      <td>
	      <table width="100%" style="height:270px;" border="0" cellspacing="12" cellpadding="12" align="center">
            <tr>
			 	<td valign="middle" align="center" colspan="2" style="font-size:14px;">Please be advised that only openSIS-CE version 4.7 and above can be upgraded to the latest version using this installer.
			 <br /><br />
             If you are running version 4.7 or above, click Continue to upgrade, otherwise click Go Back and try the New Installation.
		<br /><br />	
                <font style="color:red">  Also, remember to backup your current database and keep it in a safe place
before attempting an upgrade. OS4ED will not be responsible for data
corruption or data loss if the upgrade is unsuccessful for any reason.</font>
