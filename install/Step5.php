...
fclose($fh);
$display_text='Your system has been successfully upgraded to version 6.2. Please click the Login button to proceed to login with your existing login credentials.
';
