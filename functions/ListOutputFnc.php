		...
		if($_REQUEST['LO_save']=='1')
		{
			...
			if($options['save_delimiter']!='xml')
			{
				...
				$output .= "\n";
                        ...
                        $output='<table><tr><td><b>Class</b></td><td><b>Period - Teacher</b></td><td><b>Room</b></td><td><b>Term</b></td><td><b>Enrolled</b></td><td><b>Dropped</b></td></tr>';
				...
				if(isset($_REQUEST['_openSIS_PDF']) && $count%$repeat_headers==0)
				{
					if($count!=0)
					{
						...
						echo "<table width=100%  style=\" font-family:Arial; font-size:12px;\" >";
                                                                                                            echo "<tr><td width=105>".DrawLogo()."</td><td style=\"font-size:15px; font-weight:bold; padding-top:20px;\">". GetSchool(UserSchool())."<div style=\"font-size:12px;\">".$_SESSION['_REQUEST_vars'][0]."</div></td><td align=right style=\"padding-top:20px;\">". ProperDate(DBDate()) ."<br />Unique Amass</td></tr><tr><td colspan=3 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
					...
					if($count!=0)
					{
						...
						echo "<table width=100%  style=\" font-family:Arial; font-size:12px;\" >";
                                                if($_REQUEST['modname']=='grades/AdminProgressReports.php' || $_REQUEST['modname']=='grades/ProgressReports.php' || $_REQUEST['modname']=='users/TeacherPrograms.php?include=grades/ProgressReports.php')
                                                        echo "<tr><td width=105>".DrawLogo()."</td><td style=\"font-size:15px; font-weight:bold; padding-top:20px;\">". GetSchool(UserSchool())."<div style=\"font-size:12px;\">Student Progress Report</div></td><td align=right style=\"padding-top:20px;\">". ProperDate(DBDate()) ."<br />Unique Amass</td></tr><tr><td colspan=3 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
                                                else if($_REQUEST['modname']=='grades/ReportCards.php')
                                                        echo "<tr><td width=105>".DrawLogo()."</td><td style=\"font-size:15px; font-weight:bold; padding-top:20px;\">". GetSchool(UserSchool())."<div style=\"font-size:12px;\">Student Report Card</div></td><td align=right style=\"padding-top:20px;\">". ProperDate(DBDate()) ."<br />Unique Amass</td></tr><tr><td colspan=3 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
                                                else
                                                        echo "<tr><td width=105>".DrawLogo()."</td><td style=\"font-size:15px; font-weight:bold; padding-top:20px;\">". GetSchool(UserSchool())."<div style=\"font-size:12px;\">Add / Drop Report</div></td><td align=right style=\"padding-top:20px;\">". ProperDate(DBDate()) ."<br />Unique Amass</td></tr><tr><td colspan=3 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
						echo '<TABLE cellpadding=6 width=100% cellspacing=1 border="1px solid #a9d5e9 " style="border-collapse:collapse" align=center>';
			...
			for($i=$start;$i<=$stop;$i++)
			{
				...
				if(isset($_REQUEST['_openSIS_PDF']) && $count%$repeat_headers==0)
				{
					if($count!=0)
					{
						...
						echo "<div style=\"page-break-after: always;\"></div>";
						echo "<table width=100%  style=\" font-family:Arial; font-size:12px;\" >";
                                                                                                            echo "<tr><td width=105>".DrawLogo()."</td><td style=\"font-size:15px; font-weight:bold; padding-top:20px;\">". GetSchool(UserSchool())."<div style=\"font-size:12px;\">Student Advanced Report</div></td><td align=right style=\"padding-top:20px;\">". ProperDate(DBDate()) ."<br />Unique Amass</td></tr><tr><td colspan=3 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
						echo '<TABLE cellpadding=6 width=100% cellspacing=1 border="1px solid #a9d5e9 " style="border-collapse:collapse" align=center>';
