		...
		if($value!='')
                ...
                if($value!='')
                {
                    if($div_visibility==false)
                     return  '<table cellspacing="0" cellpadding="0"><tr><td><div id="date_div_'.$counter.'" style="display: inline" >'.ProperDateAY($value).'</div><input class="input" type=text id="date_'.$counter.'" '.$show.'  style="display:none" readonly></td><td>&nbsp; </td><td><a onClick="init('.$counter.',2);"><img src="assets/calendar.gif"  /></a><input type=hidden '.$monthVal.' id="monthSelect'.$counter.'" name="month_'.$name.'" ><input type=hidden '.$dayVal.'  id="daySelect'.$counter.'"   name="day_'.$name.'"><input type=hidden '.$yearVal.'  id="yearSelect'.$counter.'" name="year_'.$name.'" ></td></tr></table>';
                    else
                ...
                return  '<table cellspacing="0" cellpadding="0"><tr><td><input class="w3-input" type=text id="date_'.$counter.'" '.$show.'  readonly></td><td>&nbsp; </td><td><a onClick="init('.$counter.',1);"><img src="assets/calendar.gif"  /></a><input type=hidden '.$monthVal.' id="monthSelect'.$counter.'" name="month_'.$name.'" ><input type=hidden '.$dayVal.'  id="daySelect'.$counter.'"   name="day_'.$name.'"><input type=hidden '.$yearVal.'  id="yearSelect'.$counter.'" name="year_'.$name.'" ></td></tr></table>';    
