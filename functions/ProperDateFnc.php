...
function mkSisDate($year,$month,$date)
{
        ...
        $month=date(Preferences('MONTH'),strtotime($year.'-'.$month.'-'.$date));
        $day=date(Preferences('DAY'),strtotime($year.'-'.$month.'-'.$date));
        $year=date(Preferences('YEAR'),strtotime($year.'-'.$month.'-'.$date));
