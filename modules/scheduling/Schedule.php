...
function _makeDate($value, $column) {
    ...
    if ($column == 'END_DATE' && $THIS_RET[END_DATE] != '') {
        $counter++;
                return '<div style="white-space: nowrap;">' . DateInputAY($value, "schedule[$THIS_RET[COURSE_PERIOD_ID]][$THIS_RET[START_DATE]][$column]", $counter . $THIS_RET[COURSE_PERIOD_ID],'',true,$allow_na) . '</div>';
