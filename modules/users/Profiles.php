	...
	if($_REQUEST['profile_id']!='')
	{
		...
		foreach($menuprof as $modcat=>$profiles)
		{
			...
			if($modcat=='Extracurricular')
                        echo "<td class=grid style='white-space: nowrap;  padding:2px 2px 2px 6px;'>Can Use".(AllowEdit()?"<INPUT type=checkbox name=can_use_eligibility onclick='checkAll(this.form,this.form.can_use_eligibility.checked,\"can_use[eligibility\");'>":'')."</td>";
			else
                        ...
                        {
                                if($modcat=='Extracurricular')
                                echo"<td class=grid style='white-space: nowrap; padding:2px 2px 2px 6px;' > &nbsp;Can Edit ".(AllowEdit()?"<INPUT type=checkbox name=can_edit_eligibility onclick='checkAll(this.form,this.form.can_edit_eligibility.checked,\"can_edit[eligibility\");'>":'')."</td>";
                                else
