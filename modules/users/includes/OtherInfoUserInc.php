	...
	switch($field['TYPE'])
	{
		case 'text':
			...
			echo '<TD style="width:100px">';
                        ...
                        echo ($field['REQUIRED']=='Y'?'<span class=red>*</span>':'').$field['TITLE'].'</TD><TD>:</TD><TD>'._makeTextInput('CUSTOM_'.$field['ID'],'','size=25 class=cell_floating','people');
			echo '</TD>';
		...
		case 'autos':
			...
			echo '<TD style="width:100px">';
                        ...
                        echo ($field['REQUIRED']=='Y'?'<span class=red>*</span>':'').$field['TITLE'].'</TD><TD>:</TD><TD>'._makeAutoSelectInputParent('CUSTOM_'.$field['ID'],'','people');
			echo '</TD>';
		...
		case 'numeric':
			...
			echo '<TD style="width:100px">';
                        ...
                        echo ($field['REQUIRED']=='Y'?'<span class=red>*</span>':'').$field['TITLE'].'</TD><TD>:</TD><TD>'._makeTextInput('CUSTOM_'.$field['ID'],'','size=5 maxlength=10 class=cell_floating','people');
			echo '</TD>';
		...
		case 'select':
			...
			echo '<TD style="width:100px">';
                        ...
                        echo ($field['REQUIRED']=='Y'?'<span class=red>*</span>':'').$field['TITLE'].'</TD><TD>:</TD><TD>'._makeSelectInput('CUSTOM_'.$field['ID'],'','people');
			echo '</TD>';
		...
		case 'radio':
			...
			echo '<TD style="width:100px">';
                        ...
                        echo ($field['REQUIRED']=='Y'?'<span class=red>*</span>':'').$field['TITLE'].'</TD><TD>:</TD><TD>'._makeCheckboxInput('CUSTOM_'.$field['ID'],'','people');
			echo '</TD>';
