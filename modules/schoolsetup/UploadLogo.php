...
<form enctype="multipart/form-data" action="Modules.php?modname=schoolsetup/UploadLogo.php&action=upload" method="POST">';
echo '<div align=center>Select Logo: <input name="file" type="file" /><br /><br>
<input type="submit" name="Submit"  value="Upload" class=btn_medium />&nbsp;<input type=button class=btn_medium value=Cancel onclick=\'load_link("Modules.php?modname=schoolsetup/Schools.php");\'></div>
</form>';
PopTable ('footer');
}
}
