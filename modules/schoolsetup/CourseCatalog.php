...
function CreateList($dli='', $pli='', $sli='', $cli='', $mp='', $mp_name='')
{
   ...
   if($mp!='')
    ...
    $html .= "<tr><td  style=\"font-size:15px; font-weight:bold;\">". GetSchool(UserSchool())."<div style=\"font-size:12px;\">Student Schedules Report</div></td><td align=right style=\"padding-top:10px;\">". ProperDate(DBDate()) ."<br />Uniq Amass</td></tr><tr><td colspan=2 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
   ...
   if($_REQUEST['print']=='list')
	...
	echo "<tr><td  style=\"font-size:15px; font-weight:bold;\">". GetSchool(UserSchool())."<div style=\"font-size:12px;\">Course Catalog</div></td><td align=right style=\"padding-top:10px;\">". ProperDate(DBDate()) ."<br />Uniq Amass</td></tr><tr><td colspan=2 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
	 }
