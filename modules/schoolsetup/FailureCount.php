...
echo "<FORM name=failure id=failure action=Modules.php?modname=".strip_tags(trim($_REQUEST[modname]))."&modfunc=update&page_display=FAILURE method=POST>";
...
echo '<tr><td colspan="2"><CENTER>'.SubmitButton('Save','','class=btn_medium onclick="formcheck_failure_count();"').'</CENTER></td></tr>';
echo '</table>';
echo '</FORM>';
