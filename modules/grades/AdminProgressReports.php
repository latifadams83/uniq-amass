...
//                           $sum_points=0;
                         ...
                         if($_REQUEST['list_type']=='total')
			{
			  echo '<table border=0  style=\"font-size:12px;\" >';
                          ...
                          echo '<tr><td> Total Weighted Grade:</td><td>'.($programconfig[$course['TEACHER_ID']]['WEIGHT']=='Y'?_makeLetterGrade($tot_weight_grade,"",$course['TEACHER_ID'],'%').'%&nbsp;'._makeLetterGrade($tot_weight_grade,$course_period_id,$course['TEACHER_ID']):'N/A').'</td> </tr>';
                          echo '<tr><td></td></tr>';
                          echo '</table>';
                        }
                          else
