    ...
    if(!$_REQUEST['modfunc']){    
       ...
       AND mp.school_id = \''.UserSchool().'\' order by mp.post_end_date';
        ...
        echo '</FORM>';
           ...
           echo '<BR><table align=center ><tr><td align=center colspan=2><div class=student>'.$displayname.'</div><br><b>MARKING PERIOD</b><br>WEIGHTED GPA:'.sprintf('%0.2f',$gmp[$mp_id]['weighted_gpa']).'<br>UNWEIGHTED GPA:'.sprintf('%0.2f',$gmp[$mp_id]['unweighted_gpa']).'</td></tr>';
