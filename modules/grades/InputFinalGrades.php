			...
			foreach($points_RET as $student_id=>$student)
			{
                            ...
                            if($programconfig[User('STAFF_ID')]['WEIGHT']=='Y')
                            {
                                    ...
                                    if(count($grades_RET1))
                                    {
                                        ...
                                        $import_RET[$student_id] = array(1=>array('REPORT_CARD_GRADE_ID'=>_makeLetterGrade($tot_weight_grade,$course_period_id,0,'ID'),'GRADE_PERCENT'=>_makeLetterGrade($tot_weight_grade,$course_period_id,User('STAFF_ID'),'%').'%'));
                                    }
                                    else
                                    {
