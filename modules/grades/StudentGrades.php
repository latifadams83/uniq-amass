...
else
{
 ...
 if($_REQUEST['modfun']=='assgn_detail')
    ...
    $val1 .= '<table width="95%" cellpadding="2" cellspacing="2" border="0" align="center">';
     ...
     $val1 .= '<td valign=top > <strong>Description</strong></td><td valign=top >:</td><td valign=top width=55%>'.html_entity_decode(html_entity_decode($assignments_RET[1]['DESCRIPTION'])).'</td></tr>';
