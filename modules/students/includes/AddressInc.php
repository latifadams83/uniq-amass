...
//			
			...
			echo '<FIELDSET><LEGEND><FONT color=gray>Student\'s Mailing Address</FONT></LEGEND>';
                        ...
                        {    
                        $s_mail_address=DBGet(DBQuery('SELECT COUNT(1) as TOTAL FROM student_address WHERE ID!=\''.$m_addr[1]['ADDRESS_ID'].'\' AND STREET_ADDRESS_1=\''.singleQuoteReplace('','',$m_addr[1]['ADDRESS']).'\' AND STREET_ADDRESS_1=\''.singleQuoteReplace('','',$p_addr[1]['ADDRESS']).'\' AND STREET_ADDRESS_2=\''.singleQuoteReplace('','',$m_addr[1]['STREET']).'\'  AND CITY=\''.singleQuoteReplace('','',$m_addr[1]['CITY']).'\' AND STATE=\''.singleQuoteReplace('','',$m_addr[1]['STATE']).'\' AND ZIPCODE=\''.$m_addr[1]['ZIPCODE'].'\' AND TYPE=\'Home Address\' '));
			...
			echo '<div class=break></div>';
                        ...
                        $s_prim_address=DBGet(DBQuery('SELECT COUNT(1) as TOTAL FROM student_address WHERE ID!=\''.$p_addr[1]['ADDRESS_ID'].'\' AND STREET_ADDRESS_1=\''.singleQuoteReplace('','',$p_addr[1]['ADDRESS']).'\' AND STREET_ADDRESS_2=\''.singleQuoteReplace('','',$p_addr[1]['STREET']).'\' AND CITY=\''.singleQuoteReplace('','',$p_addr[1]['CITY']).'\' AND STATE=\''.singleQuoteReplace('','',$p_addr[1]['STATE']).'\' AND ZIPCODE=\''.$p_addr[1]['ZIPCODE'].'\' AND TYPE=\'Home Address\' '));
...
############################################################################################		
			...
			echo '<div class=break></div>';
                        $s_sec_address=DBGet(DBQuery('SELECT COUNT(1) as TOTAL FROM student_address WHERE ID!=\''.$s_addr[1]['ADDRESS_ID'].'\' AND STREET_ADDRESS_1=\''.singleQuoteReplace('','',$s_addr[1]['ADDRESS']).'\' AND STREET_ADDRESS_1=\''.singleQuoteReplace('','',$p_addr[1]['ADDRESS']).'\' AND STREET_ADDRESS_2=\''.singleQuoteReplace('','',$s_addr[1]['STREET']).'\'  AND CITY=\''.singleQuoteReplace('','',$s_addr[1]['CITY']).'\' AND STATE=\''.singleQuoteReplace('','',$s_addr[1]['STATE']).'\' AND ZIPCODE=\''.$s_addr[1]['ZIPCODE'].'\' AND TYPE=\'Home Address\' '));
