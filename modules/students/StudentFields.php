		...
		else
		{
			...
			if($table=='custom_fields')
			{
				...
				switch($columns['TYPE'])
				{
                                ...
                                if($columns['TYPE']=='radio' && $columns['DEFAULT_SELECTION']!='')
                                   $columns['DEFAULT_SELECTION']=substr($columns['DEFAULT_SELECTION'],0,1); 
		...
		$link = array();
                ...
                switch ($_REQUEST[category_id]) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        $arr=array('Student ID','Placed ID','Grade','Calendar','Rolling/Retention Options','Username','Password','Last Login','Disable Student'
