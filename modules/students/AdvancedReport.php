...
$_SESSION['st_arr']=$_REQUEST['st_arr'];
	...
	echo '<INPUT type=hidden name=relation>';
		...
		Widgets('eligibility');
                ...
                $extra['search'] .= '<TR><TD align=right width=120>Include courses active as of </TD><TD>'.DateInputAY('','include_active_date',1).'</TD></TR>';
		$extra['new'] = true;
		include('modules/miscellaneous/Export.php');
